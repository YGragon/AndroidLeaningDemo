...
//                finish();
        ...
        mMyAdapter.setCardClickListener(new MyAdapter.OnMyClickListener() {
            ...
            public void cardClickListener(View view, final int position) {
                Snackbar.make(view, "hehe", Snackbar.LENGTH_SHORT).setAction("heheda", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(RxJavaTestActivity.this,MActivity.class) ;
                        intent.putExtra("name",mStringList.get(position)) ;
                        startActivity(intent);
                        Toast.makeText(RxJavaTestActivity.this, "hehe,null point", Toast.LENGTH_SHORT).show();
                    }
                }).show();
            }
        });
    ...
    public void onViewClicked(View view) {
        Snackbar.make(view, "undo", Snackbar.LENGTH_LONG).setAction("hello", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(RxJavaTestActivity.this, "hello snackbar", Toast.LENGTH_SHORT).show();
            }
        }).show();
    }
}
