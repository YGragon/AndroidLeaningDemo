package com.dongxi.demo.widget;
...
public class NumberImage extends AppCompatImageView {
    public NumberImage(Context context) {
        super(context);
    }

    public NumberImage(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NumberImage(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
